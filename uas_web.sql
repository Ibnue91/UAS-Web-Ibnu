...
-- Dumping database structure for id16955473_zakat
CREATE DATABASE IF NOT EXISTS `id16955473_zakat` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `id16955473_zakat`;

-- Dumping structure for table id16955473_zakat.tb_user
...
-- Dumping data for table id16955473_zakat.tb_user: ~3 rows (approximately)
...
-- Dumping structure for table id16955473_zakat.tb_zakat
...
-- Dumping data for table id16955473_zakat.tb_zakat: ~6 rows (approximately)
...
-- Dumping structure for table id16955473_zakat.zakat
...
-- Dumping data for table id16955473_zakat.zakat: ~2 rows (approximately)
